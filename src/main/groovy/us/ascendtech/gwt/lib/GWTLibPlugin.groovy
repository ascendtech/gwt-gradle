    ...
    void apply(final Project project) {
        ...
        compileOnlyConfiguration.defaultDependencies { deps ->
            ...
            if (gwt.libs.contains("ast-aggrid")) {
                deps.add(project.dependencies.create('us.ascendtech:agGrid:0.1.11'))
                deps.add(project.dependencies.create('us.ascendtech:agGrid:0.1.11:sources'))
            }
            ...
            if (gwt.libs.contains("ast-highcharts")) {
                deps.add(project.dependencies.create('us.ascendtech:highcharts:1.1.10'))
                deps.add(project.dependencies.create('us.ascendtech:highcharts:1.1.10:sources'))

                if (gwt.includeGwtUser) {
                    deps.add(project.dependencies.create('us.ascendtech:highcharts-injector:1.1.10'))
                    deps.add(project.dependencies.create('us.ascendtech:highcharts-injector:1.1.10:sources'))
                }
            }
