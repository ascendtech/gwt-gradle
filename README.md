...
plugins {
  id "us.ascendtech.gwt.modern" version "0.9.1"
}
...
plugins {
    id "us.ascendtech.gwt.lib" version " 0.9.1"
}
...
plugins {
  id "us.ascendtech.gwt.classic" version "0.9.1"
}
...
```gradle
plugins {
    id "us.ascendtech.js.npm" version "0.9.1"
}
